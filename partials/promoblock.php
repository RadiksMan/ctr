<div class="wrapper promoblock-wrapper">
    ...
    <svg version="1.1" width="320" height="320" class="atom-circle animate-delay active" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events" style="background-color: #da4643;">
        ...
        <circle id="outside-cirle4" cx="160" cy="160" r="100" stroke="#ffffff" stroke-width="5" fill="transparent" />
        </g>
        <g class="small-circles">
        <circle id = 'small-circle1' cx="0" cy="0" r="45" stroke="#ffffff" stroke-width="5" fill="transparent"></circle>
        <circle id = 'small-circle2' cx="0" cy="0" r="17" stroke="#ffffff" stroke-width="7" fill="transparent"></circle>
        </g>
        <g class="atom-circle">
            <circle id="atom-circle" cx="160" cy="160" r="15" stroke="transparent" fill="#fff" />
        </g>
        <g class="inside-cirles first-cirle">
        <ellipse id="first-cirle" cx="160" cy="160" rx="65" ry="25" stroke="#ffffff" stroke-width="4" fill="transparent" />
        ...
        <ellipse cx="160" cy="160" rx="65" ry="25" stroke="#ffffff" stroke-width="4" fill="transparent" />
        <circle cx="96" cy="160" r="6" fill="#fff">
        ...
        <g fill = "navy">
            <text style=" font-size: 20px; font-family: Tahoma; fill:white;">
    ...
    <div class="promoblock-item-content">
        <svg version="1.1" width="328px" height="328px" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">
            <defs>
                ...
                <filter id="BGQ1-shadow1">
                    <feGaussianBlur in="SourceAlpha" stdDeviation="2" />
                    <feOffset dx="0" dy="0" result="offsetblur" />
                    <feFlood flood-color="#dc5858" />
                    <feComposite in2="offsetblur" operator="in" />
                    <feMerge>
                        <feMergeNode/>
                        <feMergeNode in="SourceGraphic" />
                ...
                <filter id="BGQ3-shadow1">
                    <feGaussianBlur in="SourceAlpha" stdDeviation="5" />
                    <feOffset dx="0" dy="0" result="offsetblur" />
                    <feFlood flood-color="#be3e3e" />
                    <feComposite in2="offsetblur" operator="in" />
                    <feMerge>
                        <feMergeNode/>
                        <feMergeNode in="SourceGraphic" />
            ...
            <polygon id='BGQ3' points="56,39 288,60 268,291 35,271" style="fill:none;stroke:#a94644;stroke-width:2"  filter="url(#BGQ3-shadow1)" />

            <polygon id='BGQ2' points="86,19 308,91 237,312 16,240" style="fill:none;stroke:#a63f3d;stroke-width:2" filter="url(#BGQ2-shadow1)" />

            <polygon id='BGQ1' points="4,214 114,8 320,118 210,324" style="fill:none;stroke:#dc5858; stroke-width:2" filter="url(#BGQ1-shadow1)" />

            <polygon id='QMain3' points="228,70 257,70 257,100 228,100" style="fill:none;stroke:white;stroke-width:3" filter="url(#drop-shadow)" />

            <polygon id='QMain1' points="78,81 245,81 245,245 78,245" style="fill:none;stroke:white;stroke-width:5" filter="url(#drop-shadow1)" />

            <polygon class='Clock' points="78,81 245,81 245,245 78,245" style="fill:none;stroke:white;stroke-width:5" filter="url(#drop-shadow)" />

            <polygon points="162,92  162,108 " style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="162,220 162,236 " style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="89,166  105,166" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="219,166  235,166" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="110,218  122,206" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="110,114  122,126" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="202,206  214,218" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            <polygon points="202,126 214,114" style="fill:none;stroke:white;stroke-width:2" filter="url(#drop-shadow)" />
            ...
            <polygon id='QMain2' points="207,51 277,51 277,120 207,120" style="fill:none;stroke:white;stroke-width:6" filter="url(#drop-shadow)" />

            <text id='text-cach' x="90" y="280" fill="white"  filter="url(#drop-shadow)" style=" font-size: 20px;font-family: Tahoma;">СЖАТЫЕ СРОКИ</text>
        </svg>
    </div>
        <div class="promoblock-text"></div>
    </div>
    <div class="promoblock-item">
        <div class="promoblock-item-content">
            ...
            <svg version="1.1" width="270px" height="315px" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">
              <defs>
                <filter id="drop-shadow">
                  <feGaussianBlur in="SourceAlpha" stdDeviation="4" />
                  <feOffset dx="0" dy="0" result="offsetblur" />
              ...
              <polygon class='BGtriangle3' points="13,184 195,1 262,250" style="fill:none;stroke:#be3e3e;stroke-width:1" filter="url(#BGtriangle3-shadow1)" />

              <polygon class='BGtriangle2' points="229,280 2,148 228,23" style="fill:none;stroke:#be3e3e;stroke-width:1" filter="url(#BGtriangle2-shadow1)" />

              <polygon class='BGtriangle1' points="8,115 260,60 180,307" style="fill:none;stroke:#dc5858; stroke-width:1" filter="url(#BGtriangle1-shadow1)" />


              <polygon id='triangleMain3' points="219,104 229,145 190,135" style="fill:none;stroke:white;stroke-width:3" filter="url(#drop-shadow)" />

              <polygon id='triangleMain1' points="188,31 241,228 42,176" style="fill:none;stroke:white;stroke-width:5" filter="url(#drop-shadow)" />
              ...
              <polygon id='triangleMain2' points="160,144 225,80 249,167" style="fill:none;stroke:white;stroke-width:6" filter="url(#drop-shadow)" />

              <text id='text-cach' x="0" y="78" fill="white" transform="rotate(-44 110,38)" filter="url(#drop-shadow)" style=" font-size: 20px;font-family: Tahoma;">КАЧЕСТВЕННО</text>
