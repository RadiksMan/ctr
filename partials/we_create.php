        ...
        <div class="works-mbox left ">
            <div class="works-item-title  animate-section">
                  <div class="item-title animate-it">
                        <div class="title-text"> <span>&#60;МЫ СОЗДАЕМ>   </span></div>
                  </div>
            </div>
            <div class="works-item-box  animate-section">
                <div class="works-item animate-it">
                    ...
                    <div class="item-anim">
                        <canvas id="canvas2" width="254" height="280" style="background-color:none"></canvas>
                    </div>
                    <div class="item-setting">Разработка <b>HTML</b> и <b>FLASH</b> баннеров c высоким <b>CTR</b>. Адаптация под любые рекламные сети. </div>
                    <a href=""><div class="item-button">оформить заявку </div></a>
                </div>
                <div class="works-item animate-it">
                    <div class="item-headed"> Landing page <br />и веб-сайты</div>
                    <div class="item-anim">
                        <canvas id="canvas3" width="300" height="280" style="background-color:none"></canvas>
                    </div>
                ...
                <div class="works-item animate-it">
                    ...
                    <div class="item-anim">
                        <canvas id="canvas4"  width="260" height="280" style="background-color:none"></canvas>
                    </div>
